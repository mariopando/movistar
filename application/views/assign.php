	...
	<?php $this->load->view('header'); ?>
		...
		<div class="row-fluid">
			...
			<div>
				...
				<ul class="breadcrumb">
					<li>
						<a href="#">Home</a> <span class="divider">/</span> Asignar
					</li>
				</ul>
				<hr>
			</div>
			...
			<div class="row-fluid">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="icon-align-justify"></i><span class="break"></span>Asignar a despachador</h2>
					</div>
					<div class="box-content">
                                            <input type="text" id="input_assign" placeholder="Ingresar"/>
                                            <div id="input_assign_content">
                                                <table class="table table-striped">
                                                    <thead class="table-bordered">
                                                        <tr>
                                                            <th></th>
                                                            <th>OLA</th>
                                                            <th>ID Logistica Externa</th>
                                                            <th>Estado</th>
                                                            <th>Asignado a</th>
                                                        </tr>
                                                    </thead>
                                        ...
                                        <div class="box-footer">
                                            ...
                                            <div class="span5">
                                                Cambiar despachador <select name="change_status" id="change_status">
                                                <?php 
                                                if(isset($dispatchers)):
                                                    foreach ($dispatchers as $key => $dispatcher) {
                                                ?>
                                                    <option value="<?php echo $dispatcher->id; ?>"><?php echo $dispatcher->name; ?></option>
                                                <?php
                                                    }
                                                endif;
                                                ?>
