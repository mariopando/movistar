	...
	<?php $this->load->view('header'); ?>
		...
		<div class="row-fluid">
			...
			<div>
				...
				<ul class="breadcrumb">
					<li>
						<a href="#">Home</a> <span class="divider">/</span> Devolver
					</li>
				</ul>
				<hr>
			</div>
			...
			<div class="row-fluid">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="icon-align-justify"></i><span class="break"></span>Devolver</h2>
					</div>
					<div class="box-content">
                                            <input type="text" id="input_send_headquarter" placeholder="Ingresar"/>
                                            <div id="input_send_headquarter_content">
                                        ...
                                        <div class="box-footer">
                                            ...
                                            <div class="span5">
                                                Cambiar estado <select name="change_status" id="change_status"><option selected="selected" value="1">Devolver casa matriz</option><option value="0">Devolver</option></select>
                                            </div>                                            
                                        </div>
...
<!--		<div class="modal hide fade" id="myModal">
	...
	<!-- start: JavaScript-->
		...
		<script src="<?php echo base_url('js/jquery.uniform.min.js'); ?>"></script>		
                ...
                <script src="<?php echo base_url('js/send_headquarter.js'); ?>"></script>
