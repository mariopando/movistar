...
<body>	
		...
		<div class="row-fluid">
			...
			<!-- start: Content -->
                            <form id="camera_file">
                                <input id="file-input" type="file" name="image" accept="image/*" capture="camera" class="input-large" value="Subir foto"/>
                            </form>
                            <pre id="output"></pre>
                            <div id="mish"></div>
			<!-- end: Content -->
	...
	<!-- start: JavaScript-->
		...
		<script src="<?php echo base_url('js/jquery.uniform.min.js'); ?>"></script>		
                ...
                <script src="<?php echo base_url('js/custom.js'); ?>"></script>
                    <script>
//                        alert(window.localStorage.getItem('img_src'));
